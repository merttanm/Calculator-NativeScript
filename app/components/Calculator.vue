        ...
        <StackLayout class="home-panel">
            ...
            <WrapLayout orientation="horizontal" class="input">
                ...
                <Button text="<-" @tap="onButtonTap('backspace', false,true)"
                    class="button" width="90" height="90" />
                <Button text="*" @tap="onButtonTap('*', true,false)"
                    class="button" width="90" height="90" />

                <Button text="7" @tap="onButtonTap(7, false, false)"
                    class="button" width="90" height="90" />
                <Button text="8" @tap="onButtonTap(8, false, false)"
                    class="button" width="90" height="90" />
                <Button text="9" @tap="onButtonTap(9, false, false)"
                    class="button" width="90" height="90" />
                <Button text="/" @tap="onButtonTap('/', true, false)"
                    class="button" width="90" height="90" />

                <Button text="4" @tap="onButtonTap(4, false, false)"
                    class="button" width="90" height="90" />
                <Button text="5" @tap="onButtonTap(5, false, false)"
                    class="button" width="90" height="90" />
                <Button text="6" @tap="onButtonTap(6, false, false)"
                    class="button" width="90" height="90" />
                <Button text="+" @tap="onButtonTap('+', true, false)"
                    class="button" width="90" height="90" />

                <Button text="1" @tap="onButtonTap(1, false, false)"
                    class="button" width="90" height="90" />
                <Button text="2" @tap="onButtonTap(2, false, false)"
                    class="button" width="90" height="90" />
                <Button text="3" @tap="onButtonTap(3, false, false)"
                    class="button" width="90" height="90" />
                <Button text="-" @tap="onButtonTap('-', true, false)"
                    class="button" width="90" height="90" />

                <Button text="0" @tap="onButtonTap(0, false, false)"
                    class="button" width="90" height="90" />
                <Button text="." @tap="onButtonTap('.', false, false)"
                    class="button" width="90" height="90" />
                <Button text="(" @tap="onButtonTap('(', false, false)"
